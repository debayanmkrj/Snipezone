...
// <summary>
// Snipper ENEMY AI - 3D Sniper Game
// 
// Features:
...
public class MoveEnemySnipper : MonoBehaviour
{
    ...
    public float OptimalAttackDistance = 80f;
    public float MinAttackDistance = 80f;
    ...
    private void ExecuteSeek()
    {
        ...
        // Fire while moving if we have LOS
