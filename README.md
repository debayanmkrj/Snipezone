...
Graduate Track/
├── Prototype/
│   ├── Snipezone_1/                    # Unity project
│   │   ├── Assets/
│   │   │   ├── Scripts/
│   │   │   │   ├── Player/             # Player movement, camera, face tracking
│   │   │   │   ├── Shooting/           # Weapon and scope systems
│   │   │   │   └── Enemy/              # AI behaviors
│   │   │   ├── Scenes/                 # Game scenes
│   │   │   ├── Ilumisoft/              # Health system asset
│   │   │   ├── JMO Assets/             # WarFX particle effects
│   │   │   └── Spags Assets/           # Crosshair textures
│   │   └── ProjectSettings/            # Unity configuration
│   ├── FaceTracking/                   # Python face tracker
│   │   ├── face_tracker.py             # Main tracking script
│   │   ├── requirements.txt            # Python dependencies
│   │   └── env.txt                     # Environment notes
│   ├── gas_mask/                       # Character 3D model and animations
│   └── audio/                          # Sound effects (Shoot.wav, Reload.wav)
├── Present/                            # Project documentation
│   └── Final Document_SnipeZone_DebayanMukherjee.pdf
├── Idea and planning/                  # Initial project proposals
└── README.md                           # This file
```
...
**Issue**: NavMesh position desync causing stuttering
**Solution**: Manual sync `agent.nextPosition = transform.position` after each move

**Issue**: Raycast hitting child objects without player component
**Solution**: Hierarchy chain checks using `GetComponentInParent<>()`

**Issue**: Floating animations during manual movement
**Solution**: Track actual position delta for `actualMovementSpeed`

**Issue**: Enemy permanent cover stuck
**Solution**: Removed health check from `ShouldExitCover()`, use time-based exit
...
- [ ] Wave-based spawning system with difficulty scaling
- [ ] Power-ups and weapon upgrades
- [ ] Multiplayer support
- [ ] Additional face tracking gestures (head tilt for lean)
- [ ] Eye gaze tracking for precise aiming
...
**Course**: AME 598 - Animating Virtual Worlds (Graduate Section)
**Institution**: Arizona State University
**Semester**: Fall 2025
**Developer**: Debayan Mukherjee

This project demonstrates the integration of computer vision techniques with real-time game development, exploring novel input methods for immersive gameplay experiences. The focus is on accessibility and innovation in human-computer interaction within virtual environments.
...
- Algorithm pseudocode for AI behaviors
- State machine flowcharts
- Accuracy formulas and tuning parameters
- Challenges encountered and solutions

Please refer to: **[Final Document_SnipeZone_DebayanMukherjee.pdf](Present/Final%20Document_SnipeZone_DebayanMukherjee.pdf)**
...
### Development
- **Game Design & Programming**: Debayan Mukherjee
- **AI Implementation**: Debayan Mukherjee
- **Face Tracking Integration**: Debayan Mukherjee

### Assets
- **3D Character Model**: gas_mask character from Unity Asset Store
- **Environment**: Industrial Set (Unity Asset Store)
- **Particle Effects**: WarFX by JMO Assets
- **Health System**: Ilumisoft Health System
- **Crosshairs**: Spags Assets
...
This project was created for educational purposes as part of the AME 598 coursework at Arizona State University.

Assets from Unity Asset Store are used under their respective licenses and are not redistributable. The custom code and scripts are available for academic reference.
...
**Developer**: Debayan Mukherjee
**Course**: AME 598 - Animating Virtual Worlds
**Institution**: Arizona State University

For questions or collaboration inquiries, please contact through the university portal.
...
Special thanks to:
- Professor and teaching staff of AME 598
- Unity Technologies for comprehensive documentation
- Google MediaPipe team for accessible computer vision tools
- Unity Asset Store creators for high-quality assets
- Fellow students for playtesting and feedback

---

**Built with Unity | Powered by MediaPipe | Created for Innovation in Interactive Media**
